            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
                    ...
                    <div className="bg-white p-8 rounded-xl shadow-sm border border-gray-100 hover:shadow-md transition-shadow flex flex-col">
                        ...
                        <div className="mt-auto flex justify-end">
                            {/* Updated Link to point to the new Guide Registration route */}
                            <Link to="/register-guide" className="bg-teal-600 text-white text-sm font-bold py-2 px-4 rounded-lg hover:bg-teal-700 transition-colors shadow-sm">
                                Register as Guide
                            </Link>
                        </div>
                    </div>
